...
const MileStoneTileTable = () => {
  ...
  const clickOpen = (v) => {
    setmilestoneStatus(milestoneStatus => milestoneStatus = true);
  }
  const clickClose = (v) => {
    setmilestoneStatus(milestoneStatus => milestoneStatus = false);
  }
    ...
    <MileStoneTileTableContainer>
      ...
      <div className='label_table_header'>
        <div>
          ...
          <span>{value.opendMileStones.length} Open</span>
        </div>
        <div>
          <svg
          ...
          <span>{value.closedMileStones.length} Closed</span>
        </div>
      </div>
      {/* 내용 부분 */}
      <section>
...
export default MileStoneTileTable;
